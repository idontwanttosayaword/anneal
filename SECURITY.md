...
| Version | Supported |
| --- | --- |
| 0.8.0 (Developer Preview) | Yes, on the target platform only — see [`docs/release/support-matrix.md`](docs/release/support-matrix.md) |
| 0.7.0 and earlier | No. A developer preview is superseded by the next one; there is no backport path. |
